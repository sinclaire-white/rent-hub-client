...
export default function FeaturedListings() {
  ...
  if (isLoading) {
    return (
      <section className="py-12 text-center">
        <h2 className="mb-8 text-3xl font-bold text-base-content">Featured Listings</h2>
  ...
  return (
    <section className="py-12">
      <h2 className="mb-8 text-3xl font-bold text-center text-base-content">Featured Listings</h2>
      <motion.div
